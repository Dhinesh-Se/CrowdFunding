    ...
    <div>
      ...
      <main className={styles.main}>
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"} align={"left"}>
          ...
          {blockchainError ? (
            <Alert status="warning" mb={6} rounded="md" alignItems="start">
              <AlertIcon mt="1" />
              <AlertDescription>
                <Text fontWeight="bold" mb={2}>{blockchainError}</Text>
                <OrderedList spacing={2} pl={4}>
                  <ListItem>Start a local chain such as Ganache on <Code>http://127.0.0.1:8545</Code>.</ListItem>
                  <ListItem>Run <Code>npm run contracts:deploy</Code>.</ListItem>
                  ...
                  <ListItem>Optional: add that value to <Code>.env.local</Code> as <Code>NEXT_PUBLIC_FACTORY_ADDRESS=0x...</Code>.</ListItem>
                  <ListItem>Restart <Code>npm run dev</Code>.</ListItem>
                </OrderedList>
                <Text mt={3}>
                  Good news: when <Code>smart-contract/deployment.json</Code> exists, the app can now use that file automatically during local development.
                </Text>
              </AlertDescription>
            </Alert>
          ) : null}
